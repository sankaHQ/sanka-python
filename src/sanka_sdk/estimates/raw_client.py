...
class RawEstimatesClient:
    ...
    ) -> HttpResponse[typing.List[EstimateSchema]]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=typing.List[EstimateSchema],  # type: ignore
    ...
    def api_routers_v_1_estimates_public_api_create_public_estimate(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PublicEstimateResponse]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PublicEstimateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def api_routers_v_1_estimates_public_api_get_public_estimate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/public/estimates/{jsonable_encoder(estimate_id)}",
            method="GET",
            params={
                "external_id": external_id,
                "lang": lang,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    EstimateSchema,
                    construct_type(
                        type_=EstimateSchema,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawEstimatesClient:
    ...
    async def api_routers_v_1_estimates_public_api_list_workspace_estimates(
        ...
        *,
        ...
        accept_language: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[EstimateSchema]]:
        """
        Parameters
        ----------
        workspace_id : typing.Optional[str]
    ...
    async def api_routers_v_1_estimates_public_api_create_public_estimate(
        ...
        *,
        ...
        total_price_without_tax: typing.Optional[float] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PublicEstimateResponse]:
        """
        Parameters
        ----------
        external_id : typing.Optional[str]
    ...
    async def api_routers_v_1_estimates_public_api_get_public_estimate(
        ...
        *,
        ...
        accept_language: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[EstimateSchema]:
        """
        Parameters
        ----------
        estimate_id : str
