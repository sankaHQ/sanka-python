...
from .object_record_line_item_row_data import ObjectRecordLineItemRowData
from .object_record_view_data import ObjectRecordViewData


class ObjectRecordLineItemListData(UncheckedBaseModel):
    object_type: str
    view: ObjectRecordViewData
    columns: typing.List[str]
    column_labels: typing.Optional[typing.Dict[str, str]] = None
    items: typing.Optional[typing.List[ObjectRecordLineItemRowData]] = None
    page: int
    page_size: int
    total: int
