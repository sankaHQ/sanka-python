...
class RawPurchaseOrdersClient:
    ...
    ) -> HttpResponse[typing.List[PurchaseOrderSchema]]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=typing.List[PurchaseOrderSchema],  # type: ignore
    ...
    def api_routers_v_1_purchase_orders_public_api_create_public_purchase_order(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PublicPurchaseOrderResponse]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PublicPurchaseOrderResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def api_routers_v_1_purchase_orders_public_api_get_public_purchase_order(
        ...
        *,
        ...
        accept_language: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PurchaseOrderSchema]:
        """
        Parameters
        ----------
        purchase_order_id : str
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/public/purchase-orders/{jsonable_encoder(purchase_order_id)}",
            method="GET",
            params={
                "external_id": external_id,
                "lang": lang,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    PurchaseOrderSchema,
                    construct_type(
                        type_=PurchaseOrderSchema,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawPurchaseOrdersClient:
    ...
    async def api_routers_v_1_purchase_orders_public_api_list_workspace_purchase_orders(
        ...
        *,
        ...
        accept_language: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[PurchaseOrderSchema]]:
        """
        Parameters
        ----------
        workspace_id : typing.Optional[str]
    ...
    async def api_routers_v_1_purchase_orders_public_api_create_public_purchase_order(
        ...
        *,
        ...
        total_price_without_tax: typing.Optional[float] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PublicPurchaseOrderResponse]:
        """
        Parameters
        ----------
        external_id : typing.Optional[str]
    ...
    async def api_routers_v_1_purchase_orders_public_api_get_public_purchase_order(
        ...
        *,
        ...
        accept_language: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PurchaseOrderSchema]:
        """
        Parameters
        ----------
        purchase_order_id : str
